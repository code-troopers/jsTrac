/**
 * Based on the work of Niklas von Hertzen 
 ...
 */
  ...
  * @param svg the svg to convert. See canvg for details on format, but it's either string or through getElement
